...
import Section2 from '../../components/landings/Section2_2'
...
const background = "/static/img/landings/Eagle-Ray-NAW.jpg"
    ...
    static async getInitialProps({ ctx, req, res, query, asPath }) {
        ...
        try {
            let [reqDestination, reqLandingEs, reqLandingEn] = await Promise.all([
                ...
                request(endPointsLa.get_landing2, null, null, 'es'),
                request(endPointsLa.get_landing2, null, null, 'en'),
            ])
