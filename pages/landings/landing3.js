...
import Section2 from '../../components/landings/Section2_3'
...
const background = "/static/img/landings/buceo-pla-del-carmen-desktop.jpg"
    ...
    static async getInitialProps({ ctx, req, res, query, asPath }) {
        ...
        try {
            let [reqDestination, reqLandingEs, reqLandingEn] = await Promise.all([
                ...
                request(endPointsLa.get_landing3, null, null, 'es'),
                request(endPointsLa.get_landing3, null, null, 'en'),
            ])
