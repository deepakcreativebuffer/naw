                            ...
                            <UncontrolledDropdown className="sty-container-element ">
                                            ...
                                            <div className="tag " style={{ marginRight: 7 }}>
                                                {moneyType === 'USD' ?
                                                    <div className='icon-moneyF'>
                                                        <Image src={dolarIconW} width="15px" height="15px" loading='lazy' />
                                                        <p>{moneyType}</p>
                                                    </div>
                                                    : moneyType === 'MXN' ?
                                                        <div className='icon-moneyF'>
                                                            <Image src={pesoIconW} width="15px" height="16px" loading='lazy'/>
                                                            <p>{moneyType}</p>
                                                        </div> :
                                                        <div className='icon-moneyF'>
                                                            <Image src={euroIconW} width="13px" height="13px" loading='lazy'/>
                                                            <p>{moneyType}</p>
                                                        </div>}
                                            </div>
                                            <div>
                                ...
                                <DropdownMenu className="drop-footer">
                                    <DropdownItem
                                        ...
                                        <div className="sty-tag"><Image src={dolarIcon} width="15px" height="16px" style={{ marginBottom: 3 }} loading='lazy' /> USD</div>
                                    </DropdownItem>
                                    ...
                                    <DropdownItem
                                        ...
                                        <div className="sty-tag"><Image src={pesoIcon} width="15px" height="16px" style={{ marginBottom: 3 }} />  MXN</div>
                                    </DropdownItem>
                                    <DropdownItem
                                        id="EUR"
                                        className="sty-uty-font-14-1 sty-justify-content-vertical sty-select-language"
                                        onClick={() => setMoneyType("EUR")}>
                                          <div className="sty-tag" ><Image src={euroIcon} width="15px" height="15px" style={{ marginBottom: 3 }} />  EUR</div>
                                    </DropdownItem>
                                </DropdownMenu>
                            ...
                            <UncontrolledDropdown className="sty-container-element ">
                                        ...
                                        <div className="tag">
                                            {moneyType === 'USD' ?
                                                <div className='icon-money'>
                                                    <img src={dolarIconW} width="15px" height="16px" />
                                                    <p>{moneyType} </p>
                                                </div>
                                                : moneyType === 'MXN' ?
                                                    <div className='icon-money'>
                                                        <img src={pesoIconW} width="15px" height="16px" />
                                                        {moneyType}
                                                    </div> :
                                                    <div className='icon-money' st>
                                                        <img src={euroIconW} width="15px" height="16px" />
                                                        {moneyType}
                                                    </div>}
                                        </div>
                                        <div>
                                ...
                                <DropdownMenu className="">
                                    <DropdownItem
                                        ...
                                        className="sty-uty-font-14-1 sty-justify-content-vertical sty-select-language"
                                        onClick={() => setMoneyType("USD")}>
                                        <div className="sty-tag"><Image src={dolarIcon} width="15px" height="16px" style={{ marginBottom: 3 }} /> USD</div>
                                    </DropdownItem>
                                    {/* <DropdownItem divider /> */}
                                    <DropdownItem
                                        id="MXN"
