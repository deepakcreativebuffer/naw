...
class NavBar extends Component {
  ...
  handleDestination = () => {
    ...
    dataDestination.map((element, i) => {
      ...
      if (cont == limit || i == (dataDestination.length - 1)) {
        elementsDestination.push(<div className="col-6" key={`dest_comp_${i}`}>
          {tempArray}
        </div>)
        tempArray = []
        cont = 0
  ...
  handleActivities = async () => {
    ...
    dataAdventure?.map((element, i) => {
      ...
      tempArray.push(
        ...
        <a href={`${constants.url}/adventures/all/all/${slug(name).toLowerCase()}`}>
          <DropdownItem className="sty-uty-font-12-2" onClick={this.toggle}>
            {name}
          </DropdownItem>
        </a>
      ...
      if (cont == limit || i == (dataAdventure.length - 1)) {
        elementsActivities.push(<div className="col-6" key={`acti_comp_${i}`}>
          {tempArray}
        </div>)
        tempArray = []
        cont = 0
  ...
  handleScroll = () => {
    ...
    function scroll() {
      ...
      if (height > 80) {
        ...
        document.getElementById("logo-img").src='/static/img/favicons/app/logo2.png';
      } else {
        barr.classList.remove('sty-nav-animation')
        barr.classList.add('sty-nav-animation-two')
        document.getElementById("logo-img").src='/static/img/favicons/app/logo.png';
      }
    }
  }
  ...
  render() {
    ...
    let tagFlag = valueLanguage == 'es' ? i18n.t('nav:lang_es') : i18n.t('nav:lang_en')
    ...
    return <>
      ...
      >
          ...
          <UncontrolledDropdown className="sty-container-element">
            <DropdownToggle nav >
              <div className="sty-language sty-justify-content">
                ...
                <div>
                  <span className="down"><FontAwesomeIcon icon={faChevronDown} width='8' height='8' /></span>
                </div>
              </div>
            </DropdownToggle>
            <DropdownMenu
            ...
            >
              ...
              >
                <div className="sty-icon"><img src={iconEsp} width='16' height='16' /></div>
              ...
              <DropdownItem
                ...
                onClick={this.handleChangeLanguage}
              >
                <div className="sty-icon"><img src={iconEn} width='16' height='16' /></div>
        ...
        <Collapse className="sty-content-elements" isOpen={this.state.isOpen} navbar>
          <Nav className="ml-auto sty-justify-content" navbar>

            <UncontrolledDropdown nav inNavbar className="sty-container-element">
              <DropdownToggle nav>
                {i18n.t('nav:destinations')}&nbsp;&nbsp;
                <span className="down"><FontAwesomeIcon icon={faChevronDown} width='16' height='16' /></span>
              </DropdownToggle>
              <DropdownMenu
                className="sty-uty-drop-menu-content-2"
              >
            ...
            <UncontrolledDropdown nav inNavbar className="sty-container-element sty-content-hidden-resp">
              <DropdownToggle nav>
                <div className="sty-language sty-justify-content">
                  <div className="icon-language">
                    <img src={tagLan} width='16' height='16' />
